# Rails CI/CD pipeline templates
...
Run development environment setup script which configures git hooks manager ([pre-commit](https://pre-commit.com/)).
```bash
make dev-setup
```
...
Reference reusable workflows from your projects.
